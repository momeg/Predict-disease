...
public:
	...
	// Permet la modification d'un attribut de l'empreinte
	// Parametres:
	// - unAttribut : attribut à inserer dans la liste des attributs de l'empreinte
	// - indice : indice auquel inserer ledit attribut
