...
// initialise les references a partir du fichier fourni
{
	catalogueEmpreintes = CatalogueEmpreintes();
...
// permet a l'utilisateur d'ajouter des empreintes de reference sans avoir 
// a refaire l'initialisation des 5000 empreintes dans son integralite
{
	string cheminFichier;
...
// analyse les empreintes fournies par l'utilisateur et genere un fichier de sortie
{
	string cheminFichier;
...
// affiche les maladies prises en compte par le systeme
// demande a l'utilisateur s'il veut des details sur l'une d'entre elle
{
	string nomMaladie;
